/****************************************************************
  ...
  File name: MotorCmd_hx.idl
  Source: MotorCmd_hx.hpp
  Cyclone DDS: v0.10.2

*****************************************************************/
#ifndef DDSCXX_MOTORCMD_HX_HPP
#define DDSCXX_MOTORCMD_HX_HPP
...
template <> constexpr const char* TopicTraits<::unitree_hx::msg::dds_::MotorCmd_>::getTypeName()
{
  return "unitree_hx::msg::dds_::MotorCmd_";
}

template <> constexpr bool TopicTraits<::unitree_hx::msg::dds_::MotorCmd_>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::unitree_hx::msg::dds_::MotorCmd_>::type_map_blob_sz() { return 478; }
template<> constexpr unsigned int TopicTraits<::unitree_hx::msg::dds_::MotorCmd_>::type_info_blob_sz() { return 100; }
template<> inline const uint8_t * TopicTraits<::unitree_hx::msg::dds_::MotorCmd_>::type_map_blob() {
 ...
 0x01,  0x00,  0x00,  0x00,  0xf2,  0xb0,  0xc1,  0xae,  0x45,  0x7d,  0xd6,  0x52,  0x38,  0xb1,  0x1d,  0x93, 
 0x38,  0x0f,  0x03,  0x00,  0xee,  0x00,  0x00,  0x00,  0xf2,  0x51,  0x01,  0x00,  0x29,  0x00,  0x00,  0x00, 
 0x00,  0x00,  0x00,  0x00,  0x21,  0x00,  0x00,  0x00,  0x75,  0x6e,  0x69,  0x74,  0x72,  0x65,  0x65,  0x5f, 
 0x68,  0x78,  0x3a,  0x3a,  0x6d,  0x73,  0x67,  0x3a,  0x3a,  0x64,  0x64,  0x73,  0x5f,  0x3a,  0x3a,  0x4d, 
 ...
 0xf2,  0xb0,  0xc1,  0xae,  0x45,  0x7d,  0xd6,  0x52,  0x38,  0xb1,  0x1d,  0x93,  0x38,  0x0f,  0x03,  0xf1, 
 0xc8,  0xe5,  0x83,  0x5b,  0x0f,  0x0c,  0x17,  0x65,  0xbc,  0x23,  0x1d,  0xfa,  0x02,  0xff, };
  return blob;
}
template<> inline const uint8_t * TopicTraits<::unitree_hx::msg::dds_::MotorCmd_>::type_info_blob() {
  static const uint8_t blob[] = {
 ...
 0x14,  0x00,  0x00,  0x00,  0xf2,  0xb0,  0xc1,  0xae,  0x45,  0x7d,  0xd6,  0x52,  0x38,  0xb1,  0x1d,  0x93, 
 0x38,  0x0f,  0x03,  0x00,  0xf2,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x04,  0x00,  0x00,  0x00, 
 0x00,  0x00,  0x00,  0x00, };
  return blob;
}
...
template <>
struct topic_type_name<::unitree_hx::msg::dds_::MotorCmd_>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::unitree_hx::msg::dds_::MotorCmd_>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::unitree_hx::msg::dds_::MotorCmd_)
...
template<>
propvec &get_type_props<::unitree_hx::msg::dds_::MotorCmd_>();

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::unitree_hx::msg::dds_::MotorCmd_& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::unitree_hx::msg::dds_::MotorCmd_& instance, bool as_key) {
  auto &props = get_type_props<::unitree_hx::msg::dds_::MotorCmd_>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::unitree_hx::msg::dds_::MotorCmd_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::unitree_hx::msg::dds_::MotorCmd_& instance, bool as_key) {
  auto &props = get_type_props<::unitree_hx::msg::dds_::MotorCmd_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::unitree_hx::msg::dds_::MotorCmd_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::unitree_hx::msg::dds_::MotorCmd_& instance, bool as_key) {
  auto &props = get_type_props<::unitree_hx::msg::dds_::MotorCmd_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::unitree_hx::msg::dds_::MotorCmd_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::unitree_hx::msg::dds_::MotorCmd_& instance, bool as_key) {
  auto &props = get_type_props<::unitree_hx::msg::dds_::MotorCmd_>();
