/****************************************************************
  ...
  File name: IMUState_hx.idl
  Source: IMUState_hx.hpp
  Cyclone DDS: v0.10.2

*****************************************************************/
#ifndef DDSCXX_IMUSTATE_HX_HPP
#define DDSCXX_IMUSTATE_HX_HPP
...
template <> constexpr const char* TopicTraits<::unitree_hx::msg::dds_::IMUState_>::getTypeName()
{
  return "unitree_hx::msg::dds_::IMUState_";
}

template <> constexpr bool TopicTraits<::unitree_hx::msg::dds_::IMUState_>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::unitree_hx::msg::dds_::IMUState_>::type_map_blob_sz() { return 498; }
template<> constexpr unsigned int TopicTraits<::unitree_hx::msg::dds_::IMUState_>::type_info_blob_sz() { return 100; }
template<> inline const uint8_t * TopicTraits<::unitree_hx::msg::dds_::IMUState_>::type_map_blob() {
 ...
 0x16,  0x01,  0x00,  0x00,  0x01,  0x00,  0x00,  0x00,  0xf2,  0xe9,  0x0f,  0x3a,  0xf0,  0x14,  0x14,  0xd4, 
 0x93,  0x6d,  0xf0,  0x5b,  0x17,  0x20,  0x75,  0x00,  0xfe,  0x00,  0x00,  0x00,  0xf2,  0x51,  0x01,  0x00, 
 ...
 0x01,  0x00,  0x00,  0x00,  0xf2,  0xe9,  0x0f,  0x3a,  0xf0,  0x14,  0x14,  0xd4,  0x93,  0x6d,  0xf0,  0x5b, 
 0x17,  0x20,  0x75,  0xf1,  0x4b,  0x1b,  0xf4,  0xaf,  0x32,  0xe5,  0xbc,  0x67,  0x10,  0xef,  0xc8,  0x29, 
 0x31,  0x15, };
  return blob;
}
template<> inline const uint8_t * TopicTraits<::unitree_hx::msg::dds_::IMUState_>::type_info_blob() {
  static const uint8_t blob[] = {
 ...
 0x14,  0x00,  0x00,  0x00,  0xf2,  0xe9,  0x0f,  0x3a,  0xf0,  0x14,  0x14,  0xd4,  0x93,  0x6d,  0xf0,  0x5b, 
 0x17,  0x20,  0x75,  0x00,  0x02,  0x01,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x04,  0x00,  0x00,  0x00, 
 0x00,  0x00,  0x00,  0x00, };
  return blob;
}
...
template <>
struct topic_type_name<::unitree_hx::msg::dds_::IMUState_>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::unitree_hx::msg::dds_::IMUState_>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::unitree_hx::msg::dds_::IMUState_)
...
template<>
propvec &get_type_props<::unitree_hx::msg::dds_::IMUState_>();

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::unitree_hx::msg::dds_::IMUState_& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::unitree_hx::msg::dds_::IMUState_& instance, bool as_key) {
  auto &props = get_type_props<::unitree_hx::msg::dds_::IMUState_>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::unitree_hx::msg::dds_::IMUState_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::unitree_hx::msg::dds_::IMUState_& instance, bool as_key) {
  auto &props = get_type_props<::unitree_hx::msg::dds_::IMUState_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::unitree_hx::msg::dds_::IMUState_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::unitree_hx::msg::dds_::IMUState_& instance, bool as_key) {
  auto &props = get_type_props<::unitree_hx::msg::dds_::IMUState_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::unitree_hx::msg::dds_::IMUState_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::unitree_hx::msg::dds_::IMUState_& instance, bool as_key) {
  auto &props = get_type_props<::unitree_hx::msg::dds_::IMUState_>();
